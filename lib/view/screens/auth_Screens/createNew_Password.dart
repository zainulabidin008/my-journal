         ...
         Container(
          ...
          child: Column(
            ...
            children: [
              ...
              customTextFormField(oldPasswordController, 'Password',
                  prefixIcon: SvgPicture.asset('assets/svgs/passwordicon.svg'),
                  isObscure: isVisible1.value==true? false:true,
                  svg: SvgPicture.asset('assets/svgs/lineicon.svg'),suffixIcon: GestureDetector(
                  onTap: (){
                    ...
                    child: SvgPicture.asset( isVisible1.value==false?'assets/svgs/notvisible.svg':"assets/svgs/visible.svg",colorFilter: const ColorFilter.mode(Color(0xff9E9FA1),BlendMode.srcIn ))),
              ),
        getVerticalSpace(1.2.h),
              customTextFormField(newPasswordController, 'Confirm Password',
                prefixIcon: SvgPicture.asset('assets/svgs/passwordicon.svg'),
                ...
                svg: SvgPicture.asset('assets/svgs/lineicon.svg'),suffixIcon: GestureDetector(
                  onTap: (){
                    ...
                    child: SvgPicture.asset( isVisible.value==false?'assets/svgs/notvisible.svg':"assets/svgs/visible.svg",colorFilter: const ColorFilter.mode(Color(0xff9E9FA1),BlendMode.srcIn ),)),
              ),
